import {
  A as pingServer,
  C as isBrowserExtension,
  D as isIE,
  E as isEmpty,
  M as querystringDecode,
  O as isMobileCordova,
  S as getUA,
  T as isCloudflareWorker,
  _ as deepEqual,
  a as getApp,
  b as getExperimentalSetting,
  c as registerVersion,
  d as Component,
  f as Deferred,
  g as createSubscribe,
  h as base64Decode,
  ...
  t as SDK_VERSION,
  u as Logger,
  v as extractQuerystring,
  w as isCloudWorkstation,
  x as getModularInstance,
  y as getDefaultEmulatorHost,
