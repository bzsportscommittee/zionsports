...
var ComponentContainer = class {
  ...
  addOrOverwriteComponent(component) {
    if (this.getProvider(component.name).isComponentSet())
...
function initializeApp(_options, rawConfig = {}) {
  ...
  if (typeof name !== "string" || !name)
    throw ERROR_FACTORY.create("bad-app-name", { appName: String(name) });
...
function getApp(name = DEFAULT_ENTRY_NAME) {
  ...
  if (!app && name === "[DEFAULT]" && getDefaultAppConfig())
...
export {
  ...
  isIE as D,
  isEmpty as E,
  querystringDecode as M,
  globalthis_default as N,
  isMobileCordova as O,
  getUA as S,
  isCloudflareWorker as T,
  deepEqual as _,
  getApp as a,
  getExperimentalSetting as b,
  registerVersion as c,
  Component as d,
  Deferred as f,
  createSubscribe as g,
  base64Decode as h,
  _registerComponent as i,
  querystring as j,
  isReactNative as k,
  LogLevel as l,
  FirebaseError as m,
  ...
  isCloudWorkstation as w,
  getModularInstance as x,
  getDefaultEmulatorHost as y,
};
