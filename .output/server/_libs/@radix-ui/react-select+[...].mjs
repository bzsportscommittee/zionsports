...
function SelectProvider(props) {
  ...
  import_react.useEffect(() => {
    const associatedForm = form
      ? trigger?.ownerDocument.getElementById(form)
      : trigger?.form;
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        import_jsx_runtime.Fragment,
        {
          children: [
            children,
            isFormControl
              ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectBubbleInput, {
                  __scopeSelect,
                })
              : null,
          ],
...
var SelectArrow = import_react.forwardRef((props, forwardedRef) => {
  ...
  const popperScope = usePopperScope(__scopeSelect);
  return useSelectContentContext(ARROW_NAME, __scopeSelect).position ===
    "popper"
